...
// Autor: Ana Paula de Oliveira Silva - Data: 25/03/2024
// Enunciado: Imc, notas e dolar
//***************************************************************
...
const server = http.createServer((req, res) => {
    ...
    if (path === '/') {
        ...
        if (isNaN(valorDolar) || isNaN(valorReais)) {
            ...
            res.writeHead(200, { "Content-Type": "text/plain; charset=utf-8" })
            res.end(`R$${valorReais.toFixed(2)} por U$${valorDolar.toFixed(2)} é igual u$${convertido.toFixed(2)}convertido`)
        }
